...
public class ServerMainClass {
	...
	public static void main(String[] args) {
		...
		try {
			...
			serverSocket.bind(new InetSocketAddress("localhost" , 9090));	// 호스트가 localhost, 포트번호가 9090
			...
			while(true) {
				...
				System.out.println("접속한 클라이언트 정보 : " + socket.getInetAddress()); 		// 접속한 클라이언트의 IP 주소 확잉ㄴ
			}
