...
public class MainClass {
	...
	*/
	...
	public static void ex06() {
		...
		File dir2 = new File("C:\\storage2","diary.txt");
		
		try (BufferedWriter bw = new BufferedWriter(new FileWriter(dir2))){
	...
	public static void ex07() {
		...
		try {
			...
			br = new BufferedReader(new InputStreamReader(System.in));		//	파일대신 키보드로 바뀌고 속도가 향상되는 코드.
	...
	public static void ex08() {
		...
		String sep = File.separator;
		File from = new File("C:"+ sep + "GDJ61"+ sep +"install"+ sep + "eclipse-jee-2021-03-R-win32-x86_64.zip");
		...
		try {
			...
			byte[] b = new byte[1024];	// 1킬로바이트씩 옮기기
			int readByte = 0;
