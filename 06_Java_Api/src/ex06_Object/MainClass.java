...
public class MainClass {
	...
	/*
		...
		1. 모든 클래스의 최상위 슈퍼 클래스이다.  // 슈퍼 클래스 = (모두의)부모 클래스
	...
	/*
		...
		1. equals   
		 	1) 동등 비교할 때 사용하는 메소드
		 	2) 동등 비교하는 객체들의 참조값을 비교함(객체의 값을 비교하지 못한다.)
	 ...
	 */
		...
		public static void ex02() {
			...
			if(person1.equals(person2)) {                           //같은 Person이기 위해서는 if(person1.equals(person1)) 이 되어야한다. 
